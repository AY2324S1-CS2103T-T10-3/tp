...
with(this){return _c('p',[_v("Extensions:"),_c('br'),_v("\n3a. AddCommandParser detects invalid format for user input."),_c('br'),_v("\n3a1. AddCommandParser throws CommandException."),_c('br'),_v("\n3a2. Produces error message in command result."),_c('br'),_v("\n3a3. User retypes input."),_c('br'),_v("\nRepeat from step 2.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("3b. AddCommandParser detects duplicate for user input."),_c('br'),_v("\n3b1. AddCommandParser throws CommandException."),_c('br'),_v("\n3b2. Produces error message stating duplicate person in command result."),_c('br'),_v("\n3b3. user retypes input."),_c('br'),_v("\nRepeat from step 2")])}
},function anonymous(
) {
with(this){return _c('p',[_v("System: ProjectPRO"),_c('br'),_v("\nUse case: Delete contact"),_c('br'),_v("\nActor: user"),_c('br'),_v("\nRun projectPRO"),_c('br'),_v("\n1.Type in the contact name in the input bar with the delete command."),_c('br'),_v("\n2.Parser reads “delete” in input and instantiates a deleteCommandParser."),_c('br'),_v("\n3.deleteCommandParser instantiates deleteCommand."),_c('br'),_v("\n4.deleteCommand is executed and produces message success commandResult."),_c('br'),_v("\n5.Use Case ends")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Extensions"),_c('br'),_v("\n3a. deleteCommandParser detects invalid format for user input."),_c('br'),_v("\n3a1. deleteCommandParser throws CommandException."),_c('br'),_v("\n3a2. Produces error message in command result"),_c('br'),_v("\n3a3. Steps 2-3 are repeated until the data entered are correct."),_c('br')])}
},function anonymous(
) {
with(this){return _c('p',[_v("Use case: Add contact to group"),_c('br'),_v("\nActor: user"),_c('br'),_v("\nRun projectPRO"),_c('br'),_v("\n1.Type in the group command."),_c('br'),_v("\n2.Parser reads “group” in input and instantiates a groupParser."),_c('br'),_v("\n3.groupParser instantiates groupCommand."),_c('br'),_v("\n4.groupCommand is executed and produces message success commandResult."),_c('br'),_v("\n5.Use Case ends"),_c('br')])}
},function anonymous(
) {
with(this){return _c('p',[_v("Extensions"),_c('br'),_v("\n3a. projectPRO detects an error in the entered data."),_c('br'),_v("\n3a1. projectPRO requests for the correct data."),_c('br'),_v("\n3a2. User enters new data"),_c('br'),_v("\n3a3. Steps 3a1-3a2 are repeated until the data entered are correct."),_c('br'),_v("\nUse case resumes from step 4.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Wed, 4 Oct 2023, 22:43:27 GMT+8]")])])])}
}];
